...
2.  Link the `DataStore` directory to your system's Arduino Library directory.
    - Windows:
        - Using windows explorer, open the directory where DataStore is located
        - Right click on the DataStore folder and select "make shortcut"
        - Cut the newly created shortcut
        - Past the shortcut in `C:\Users\<user>\Documents\Arduino\Libraries\`

    - Linux:
        - Run: `ln -s <path to DataStore> /home/<username>/arduino/libraries/`
 
    - Mac OS:
        - Run: `ln -s <path to DataStore> /Users/<username>/Documents/arduino/libraries/`
